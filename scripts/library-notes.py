...
class LibraryNotes(scripts.Script):
    ...
    def loadLibraryNotes(self, *args, **kwargs):
        LibraryNotes.checkpoint_list = self.pull_note_list(LibraryNotes.checkpoint_path, ['.safetensors', '.ckpt'])
        LibraryNotes.hypernetwork_list = self.pull_note_list(LibraryNotes.hypernetwork_path, ['.pt'])
        LibraryNotes.lora_list = self.pull_note_list(LibraryNotes.lora_path, ['.safetensors', '.pt'])
        LibraryNotes.embedding_list = self.pull_note_list(LibraryNotes.embedding_path, ['.bin', '.pt'])
        LibraryNotes.vae_list = self.pull_note_list(LibraryNotes.vae_path, ['.bin', '.pt'])
